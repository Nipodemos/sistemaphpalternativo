...
const loginSchema = z.object({
	filtro: z.union([z.literal("cor"),z.literal('acabamento'),z.literal("ambos")],{message:'selecione o tipo de pesquisa'}),
	textoPesquisa: z.string().min(3, 'senha precisa ter pelo menos 3 caracteres')
});
